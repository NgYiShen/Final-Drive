...
func _process(delta):
	...
	for i in range(points.size()):
		...
		var currAlpha = 1 - lifePoints[i] / lifespan  # Calculate alpha based on remaining lifespan
		var currColor = Color(startColor.r, startColor.g, startColor.b, currAlpha)  # Update color with alpha
